      ...
      <div class="antv-menu">
        ...
        <ul class="menu-list">
          <li draggable="true" @drag="menuDrag('defaultOval')">
            <i class="icon-oval"></i> <strong>开始</strong>
          </li>
          <li draggable="true" @drag="menuDrag('defaultSquare')">
            <i class="icon-square"></i><strong>信息提交</strong>
          </li>
          <li draggable="true" @drag="menuDrag('defaultYSquare')">
            <i class="icon-ysquare"></i><strong>流程/属性添加</strong>
          </li>
          <li draggable="true" @drag="menuDrag('defaultRhombus')">
            <i class="icon-rhombus"></i><strong>是否通过</strong>
          </li>
          <li draggable="true" @drag="menuDrag('defaultRhomboid')">
            <i class="icon-rhomboid"></i><strong>处理节点</strong>
          </li>
          <li draggable="true" @drag="menuDrag('defaultCircle')">
            <i class="icon-circle"></i><strong>结束</strong>
          </li>
...
export default {
  ...
  props: {
    ...
    value: {
      type: String,
      default: JSON.stringify(initData),
    },
  },
  data() {
    return {
      ...
      drawer: false,
      jsonData: syntaxHighlight(initData),
    };
  },
  created() {},
  watch: {
